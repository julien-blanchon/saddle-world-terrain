//! Physics colliders example — terrain with collision mesh generation enabled.
//!
//! Demonstrates `TerrainColliderConfig`: setting `enabled = true`,
//! `resolution_divisor` (lower resolution for cheaper colliders), and
//! `streaming.collider_radius` to control how far from the focus colliders
//! are generated.
...
fn main() {
    ...
    app.add_plugins(DefaultPlugins.set(WindowPlugin {
        primary_window: Some(Window {
            title: "Terrain — Physics Colliders".into(),
