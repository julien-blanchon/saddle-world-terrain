//! Clipmap debug example — LOD-colored terrain chunks.
//!
//! Uses `TerrainDebugColorMode::ByLod` to tint each chunk by its LOD level,
//! making the clipmap streaming structure visible. The focus entity orbits
//! the terrain center so you can watch chunks transition between LOD levels.
...
fn main() {
    ...
    app.add_plugins(DefaultPlugins.set(WindowPlugin {
        primary_window: Some(Window {
            title: "Terrain — Clipmap Debug".into(),
